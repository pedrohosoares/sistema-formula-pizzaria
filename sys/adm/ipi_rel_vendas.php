...
function atualizar_grafico()
{
    ...
    grafico_vendas.setDataURL('ipi_rel_vendas_ajax.php?param=1,' + cod_pizzarias +','+ data_inicial +','+ periodo_grafico+','+ data_final);
    ...
    grafico_combo.setDataURL('ipi_rel_vendas_ajax.php?param=4,' + cod_pizzarias +','+ data_inicial +','+ periodo_grafico+','+ data_final);
