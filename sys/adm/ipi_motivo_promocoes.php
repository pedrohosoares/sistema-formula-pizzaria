...
cabecalho('Cadastro de Motivos de Promoções');

$acao = validaVarPost('acao');

$chave_primaria = 'cod_motivo_promocoes';
$tabela = 'ipi_motivo_promocoes';
$campo_ordenacao = 'motivo_promocao';
$campo_filtro_padrao = 'motivo_promocao';
$quant_pagina = 50;
...
switch ($acao)
{
    ...
    case 'editar':
        ...
        $motivo_promocao = validaVarPost('motivo_promocao');
        ...
        if ($codigo <= 0)
        {
            $sql_edicao = sprintf("INSERT INTO $tabela (motivo_promocao, situacao) VALUES ('%s', '%s')", $motivo_promocao, $situacao);
    ...
    tabs.addEvent('change', function(indice)
    {
        if(indice == 1)
        {
            ...
            echo $chave_primaria?>.value = '';
      		document.frmIncluir.motivo_promocao.value = '';
        ...
        <table class="listaEdicao" cellpadding="0" cellspacing="0"
            ...
            <thead>
                <tr>
                    ...
                    <td align="center">Motivo Promoção</td>
...
<table align="center" class="caixa" cellpadding="0" cellspacing="0">
    <tr>
        <td class="legenda tdbl tdbt tdbr">
            <label for="motivo_promocao" class="requerido" >Motivo Promoção</label>
        </td>
    </tr>
    <tr>
        <td class="tdbl tdbr sep">
            <input type="text"  name="motivo_promocao" class="requerido" id="motivo_promocao" maxlength="45" size="20" value="<?echo bd2texto($obj_editar->motivo_promocao)?>">
        </td>
    </tr>
