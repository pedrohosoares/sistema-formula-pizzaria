...
if ($acao == "buscar")
{
    ...
    cod_pizzarias   int(10)     UNSIGNED  
    cod_ingredientes  int(10)     UNSIGNED  
    cod_bebidas_ipi_conteudos   int(10)     UNSIGNED  
    data_movimentacao   date     
    quantidade_teorico  decimal(10,3)       
    quantidade_compras  decimal(10,3)       
    quantidade_vendas   decimal(10,3)      
    quantidade_ajuste   decimal(10,3)       
    ultima_compra_data  date      
    ultima_compra_valor   decimal(5,2)      
    ultima_compra_quantidade  decimal(10,3)        
    ultima_compra_preco_grama   decimal(11,8)      
    saldo_inicial   decimal(10,3)       
    saldo_final   decimal(10,3)      
    quantidade_fidelidade   decimal(10,3)      
    quantidade_combo  decimal(10,3)      
    quantidade_lanche   decimal(10,3)      
    quantidade_promocao

  */
    $sql_buscar_movimentacoes = "SELECT em.cod_ingredientes,em.cod_bebidas_ipi_conteudos,em.data_movimentacao,sum(em.quantidade_teorico) as quantidade_teorico,sum(em.quantidade_compras) as quantidade_compras,AVG(em.ultima_compra_preco_grama) as ultima_compra_preco_grama,sum(em.quantidade_vendas) as quantidade_vendas,sum(em.quantidade_ajuste) as quantidade_ajuste, sum(em.saldo_inicial) as saldo_inicial, sum(em.saldo_final) as saldo_final,sum(em.quantidade_fidelidade) as quantidade_fidelidade,sum(em.quantidade_combo) as quantidade_combo, sum(em.quantidade_lanche) as quantidade_lanche,sum(em.quantidade_promocao) as quantidade_promocao,sum(em.quantidade_compras*em.ultima_compra_preco_grama) as total_entrada_compra, i.ingrediente from ipi_estoque_mapa em left join ipi_ingredientes i on i.cod_ingredientes = em.cod_ingredientes where em.cod_pizzarias in ($cod_pizzarias_usuario) and em.cod_pizzarias in($cod_pizzarias) and em.data_movimentacao between '$data_inicial' and '$data_final'";
    ...
    if($titulos_subcategorias!="")
      ...
      $sql_buscar_movimentacoes .= ' GROUP BY em.cod_ingredientes,em.cod_bebidas_ipi_conteudos ORDER BY em.data_movimentacao ASC,em.cod_bebidas_ipi_conteudos ASC,i.ingrediente ASC,em.cod_bebidas_ipi_conteudos ASC';
    ...
    $num_ing = mysql_num_rows($res_buscar_movimentacoes);
      ...
      <thead>
        ...
        <tr>
          ...
          <td align="center" width="90" align="center">Preço do Grama</td>
<!--           <td align="center" width="90" align="cener">Data da Movimen.</td>
         ...
         <!--  <td align="center" width="90" align="center">Docto de movimentacao</td>  -->
          ...
          <td align="center" width="90" align="right">(+)<br/>Compras<br/>(R$)</td>
...
echo "<pre>";
    ...
    $saldo_total['entrada_dinheiro'] = 0;
    $mov_cont = 0;
   ...
   // {
      ...
      $preco_grama = ($obj_buscar_movimentacoes->total_entrada_compra/($obj_buscar_movimentacoes->quantidade_compras >0 ?$obj_buscar_movimentacoes->quantidade_compras : 1));
     // echo "<br/>-".$preco_grama."-";
      if($preco_grama<=0)
      {
    ...
    {*/
      ...
      $entrada_dinheiro = $entrada * $preco_grama;
      $saldo_total['entrada_dinheiro'] += $entrada_dinheiro;
      ...
      $tabela .= "<td align='center'>".$nome_exibicao."</td>";//".$obj_buscar_movimentacoes->total_entrada_compra."
      $tabela .= "<td align='center'>".str_replace(".", ",", $preco_grama)."</td>";//."<br/>".str_replace(".", ",", $preco_grama)
/*      $tabela .= "<td align='center'>".bd2data($data_inicial)." até ".bd2data($data_final)."</td>";//date("d/m/Y",strtotime($obj_buscar_movimentacoes->data_movimentacao))
    ...
    //  echo "<td align='center'>".$infos["nota_fiscal"]."</td>";
      ...
      $tabela .= "<td align='right'>".bd2moedacomzero($entrada_dinheiro)."</td>";
    ...
    //  echo "<td align='center'>".$infos["nota_fiscal"]."</td>";
      ...
      echo "<td align='right'>".bd2moedacomzero($saldo_total['entrada_dinheiro'])."</td>";
