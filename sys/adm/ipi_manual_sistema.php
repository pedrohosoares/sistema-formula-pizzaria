...
$chave_primaria = 'cod_manuais';
$tabela = 'ipi_manuais';
$campo_ordenacao = 'cod_manuais';
$campo_filtro_padrao = 'cod_manuais';
$quant_pagina = 50;
    ...
    case 'editar':
        ...
        if ($cod_menus <= 0)
        {
            if (trim($nome_menu) != '')
            {
                ...
                if (!mysql_query($sql_edicao))
                {
                    exibir_mensagem_erro('Erro ao inserir o menus', 'Por favor, verifique se o menu já não se encontra cadastrado.');
                }
            }
        }
        else
        {
            if (trim($nome_menu) != '')
            {
                ...
                if (!mysql_query($sql_edicao))
                {
                    exibir_mensagem_erro('Erro ao alterar o menus', 'Por favor, verifique se o menu já não se encontra cadastrado.');
                }
            }
        }
