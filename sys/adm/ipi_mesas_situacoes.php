...
cabecalho('Cadastro Situações das Mesas');
        ...
        <table class="listaEdicao" cellpadding="0" cellspacing="0"
            ...
            <thead>
              <tr>
                ...
                <td align="center">Situação da Mesa</td>
                <td align="center">Cor da Situação</td>
              </tr>
            </thead>
            <tbody>
            <?
...
<table align="center" class="caixa" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td class="legenda tdbl tdbt tdbr"><label class="requerido" for="situacao">Situação da Mesa</label></td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="legenda tdbl tdbr"><label for="cor_situacao">Cor da Situação</label></td>
    </tr>
    <tr>
