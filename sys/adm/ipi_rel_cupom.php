        ...
        <table class="listaEdicao" cellpadding="0" cellspacing="0">
          ...
          while ($objBuscaRegistros = mysql_fetch_object($resBuscaRegistros)) {
            if($objBuscaRegistros->num_utilizacoes > 0) {
              ...
              echo '<td align="center" align="left" style="padding-left: 10px;"><a href="javascript:;" onclick="trocar(\''.$objBuscaRegistros->cod_cupons.'\',\''.$cliente.'\',\''.$cod_pizzarias.'\')">'.bd2texto($objBuscaRegistros->cupom).'</a><br/>('.$objBuscaRegistros->obs_cupom.') </td>';
