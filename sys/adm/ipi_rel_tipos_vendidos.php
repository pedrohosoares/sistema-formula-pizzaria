  ...
  <tr>
    ...
    <td class="tdbr">
      <select name="tipo_entrega" id="tipo_entrega">
        ...
        <option value="Balcão a Distancia" <? if($tipo_entrega == "Balcão a Distancia") echo "selected='selected'" ?>><?php echo traduzir_tipo_entrega("Balcão a Distancia"); ?></option>
        <option value="Balcão" <? if($tipo_entrega == "Balcão") echo "selected='selected'" ?>><?php echo traduzir_tipo_entrega("Balcão"); ?></option>
