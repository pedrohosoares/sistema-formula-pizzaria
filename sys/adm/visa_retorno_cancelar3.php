 ...
 echo '<b> TRANSAÇÃO </b><br />';
    ...
    echo '<b>Valor do cancelamento (valor): </b>' . $retorno_valor_cancelamento . '<br />';
        ...
        if ($retorno_status==9)
        {
            ...
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES (".$objBuscaPedido->cod_pedidos.",'cancel_retorno_tid','".$retorno_tid."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES (".$objBuscaPedido->cod_pedidos.",'cancel_retorno_pan','".$retorno_pan."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES (".$objBuscaPedido->cod_pedidos.",'cancel_retorno_pedido','".$retorno_pedido."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES (".$objBuscaPedido->cod_pedidos.",'cancel_retorno_valor','".$retorno_valor."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES (".$objBuscaPedido->cod_pedidos.",'cancel_retorno_moeda','".$retorno_moeda."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES (".$objBuscaPedido->cod_pedidos.",'cancel_retorno_data_hora','".$retorno_data_hora."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES (".$objBuscaPedido->cod_pedidos.",'cancel_retorno_descricao','".$retorno_descricao."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES (".$objBuscaPedido->cod_pedidos.",'cancel_retorno_idioma','".$retorno_idioma."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES (".$objBuscaPedido->cod_pedidos.",'cancel_retorno_bandeira','".$retorno_bandeira."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES (".$objBuscaPedido->cod_pedidos.",'cancel_retorno_produto','".$retorno_produto."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES (".$objBuscaPedido->cod_pedidos.",'cancel_retorno_parcelas','".$retorno_parcelas."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES (".$objBuscaPedido->cod_pedidos.",'cancel_retorno_status','".$retorno_status."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES (".$objBuscaPedido->cod_pedidos.",'cancel_retorno_url_autenticacao','".$retorno_url_autenticacao."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES (".$objBuscaPedido->cod_pedidos.",'cancel_retorno_codigo_cancelamento','".$retorno_codigo_cancelamento."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES (".$objBuscaPedido->cod_pedidos.",'cancel_retorno_mensagem_cancelamento','".$retorno_mensagem_cancelamento."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES (".$objBuscaPedido->cod_pedidos.",'cancel_retorno_data_hora_cancelamento','".$retorno_data_hora_cancelamento."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES (".$objBuscaPedido->cod_pedidos.",'cancel_retorno_valor_cancelamento','".$retorno_valor_cancelamento."')";
            $resAux =  mysql_query($sqlAux);

            
            $sqlPed = "UPDATE ipi_pedidos SET situacao = 'CANCELADO', data_hora_cancelamento = '".date("Y-m-d H:i:s")."', cod_usuarios_cancelamento='".$_SESSION['usuario']['codigo']."' WHERE cod_pedidos=".$objBuscaPedido->cod_pedidos;
