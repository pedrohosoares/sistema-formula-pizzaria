...
/**
 * Cadastro de Tipos Lançamentos de Estoque.
 *
 * @version 1.0
...
cabecalho('Cadastro de Tipos de Lançamentos de Estoque');

$acao = validaVarPost('acao');

$chave_primaria = 'cod_estoque_tipo_lancamento';
$tabela = 'ipi_estoque_tipo_lancamento';
$campo_ordenacao = 'estoque_tipo_lancamento';
$campo_filtro_padrao = 'estoque_tipo_lancamento';
$quant_pagina = 50;
...
switch ($acao)
{
    ...
    case 'editar':
        ...
        $estoque_tipo_lancamento = validaVarPost('estoque_tipo_lancamento');
        
        $conexao = conectabd();
        
        if ($codigo <= 0)
        {
            $sql_edicao = sprintf("INSERT INTO $tabela (estoque_tipo_lancamento) VALUES ('%s')", $estoque_tipo_lancamento);
        ...
        {
            $sql_edicao = sprintf("UPDATE $tabela SET estoque_tipo_lancamento = '%s' WHERE $chave_primaria = $codigo", $estoque_tipo_lancamento);
...
window.addEvent('domready', function()
{
    ...
    tabs.addEvent('change', function(indice)
    {
        if(indice == 1)
        {
            ...
            document.frmIncluir.estoque_tipo_lancamento.value = '';
        ...
        <table class="listaEdicao" cellpadding="0" cellspacing="0"
            ...
            <thead>
                <tr>
                    ...
                    <td align="center">Tipos de Lançamento de Estoque</td>
                </tr>
            </thead>
            <tbody>
            ...
            while ($obj_buscar_registros = mysql_fetch_object($res_buscar_registros))
            {
                ...
                echo '<td align="center"><a href="#" onclick="editar(' . $obj_buscar_registros->$chave_primaria . ')">' . bd2texto($obj_buscar_registros->estoque_tipo_lancamento) . '</a></td>';
...
<table align="center" class="caixa" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td class="legenda tdbl tdbt tdbr"><label class="requerido"
            for="estoque_tipo_lancamento">Tipo de Lançamento de Estoque</label></td>
    </tr>
    <tr>
        <td class="tdbl tdbr sep"><input class="requerido" type="text"
            name="estoque_tipo_lancamento" id="estoque_tipo_lancamento" maxlength="45" size="45"
            value="<? echo bd2texto($obj_editar->estoque_tipo_lancamento) ?>"></td>
    </tr>
