...
cabecalho('Captura de Pagamentos CIELO');
...
{
    window.open("visa_retorno_cancelar3.php?cod="+cod, "Pedido"+cod, "height = 300, width = 400");
}

function capturar(cod)
{
	window.open("visa_retorno_captura3.php?cod="+cod, "Pedido"+cod, "height = 300, width = 400");
}
