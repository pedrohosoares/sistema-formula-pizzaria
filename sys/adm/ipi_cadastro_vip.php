        ...
        <table class="listaEdicao" cellpadding="0" cellspacing="0"
            ...
            <thead>
                <tr>
                    ...
                    <td align="center" width="30">Classificação VIP</td>
                    <td align="center" width="30">Nível VIP</td>
...
<table align="center" class="caixa" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td class="legenda tdbl tdbt tdbr"><label class="requerido" for="classificacao_vip">Classificação VIP</label></td>
    </tr>
    <tr>
