...
$cod_secoes = 4; //Seleciona o tipo de secao.
...
cabecalho('Cadastro de Mensagens para Fanqueadores');
...
function excluirImagem(cod) 
{
  if (confirm('Deseja excluir esta imagem?\n\nATENÇÃO: Este é um processo irreversível.')) 
  {
    ...
    if (cod_imagem > 0) 
    {
      var url = 'acao=' + acao + '&cod_imagem=' + cod_imagem;
      
      new Request.JSON({url: 'iti_texto_sistema_ajax.php', onComplete: function(retorno) {
