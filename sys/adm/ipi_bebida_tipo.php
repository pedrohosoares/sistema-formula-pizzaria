...
cabecalho('Cadastro de Tipo de Bebidas');

$acao = validaVarPost('acao');

$tabela = 'ipi_tipo_bebida';
$chave_primaria = 'cod_tipo_bebida';
...
switch($acao) {
  ...
  case 'editar':
    ...
    if($codigo <= 0) {
      $SqlEdicao = sprintf("INSERT INTO $tabela (tipo_bebida, situacao) VALUES ('%s', '%s')", 
                           $bebida, $situacao);
      //echo $SqlEdicao;
      ...
      $SqlEdicao = sprintf("UPDATE $tabela SET tipo_bebida = '%s', situacao = '%s' WHERE $chave_primaria = $codigo", 
...
<div id="tabs">
        ...
        <table class="listaEdicao" cellpadding="0" cellspacing="0">
          <thead>
            <tr>
              ...
              <td align="center">Tipo de bebidas</td>
          ...
          $SqlBuscaRegistros = "SELECT * FROM $tabela ORDER BY tipo_bebida ASC ";
  ...
  <div class="painelTab">
    ...
    <tr><td class="legenda tdbl tdbt tdbr"><label class="requerido" for="bebida">Tipo da bebida</label></td></tr>
    <tr><td class="tdbl tdbr sep"><input class="requerido" type="text" name="bebida" id="bebida" maxlength="45" size="45" value="<? echo texto2bd($objBusca->tipo_bebida) ?>"></td></tr>
     <tr>
