...
/**
 * ipi_conteudo.php: Cadastro Conteúdo
 * 
 * Índice: cod_conteudos
...
cabecalho('Cadastro de Conteúdo');
...
<div id="tabs">
  ...
  <div class="painelTab">
   ...
   <tr><td class="legenda tdbl tdbt tdbr"><label class="requerido" for="tamanho_conteudo">Conteúdo</label></td></tr>
