...
cabecalho('Cadastro de Franqueados');

$acao = validaVarPost('acao');

$chave_primaria = 'cod_franqueados';
$tabela = 'ipi_franqueados';
...
switch ($acao)
{
    ...
    case 'editar':
        ...
        $profissao = validaVarPost('profissao');
        ...
        $id_nextel = validaVarPost('id_nextel');
        ...
        if ($codigo <= 0)
        {
            $sql_edicao = sprintf("INSERT INTO $tabela (cod_pizzarias, nome, email, cpf, cep, endereco, numero , complemento, bairro, cidade, estado, telefone_residencial, telefone_recado, celular, id_nextel, situacao, data_nascimento, sexo, rg, estado_civil, tem_filhos, escolaridade, profissao, fumante, bebida_alcoolica, animais_estimacao, observacoes) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')", 
                $cod_pizzarias, $nome, $email, $cpf, $cep, $endereco, $numero, $complemento, $bairro, $cidade, $estado, $telefone_residencial, $telefone_recado, $celular, $id_nextel, $situacao, $data_nascimento, $sexo, $rg, $estado_civil, $tem_filhos, $escolaridade, $profissao, $fumante, $bebida_alcoolica, $animais_estimacao, $observacoes);
        ...
        {
            $sql_edicao = sprintf("UPDATE $tabela SET cod_pizzarias = '%s', nome = '%s', email = '%s', cpf = '%s', cep = '%s', endereco = '%s', numero = '%s', complemento = '%s', bairro = '%s', cidade = '%s', estado = '%s', telefone_residencial = '%s', telefone_recado = '%s', celular = '%s', id_nextel = '%s', situacao = '%s', data_nascimento = '%s', sexo = '%s', rg = '%s', estado_civil = '%s', tem_filhos = '%s', escolaridade = '%s', profissao = '%s', fumante = '%s', bebida_alcoolica = '%s', animais_estimacao = '%s', observacoes = '%s' WHERE $chave_primaria = $codigo", 
            $cod_pizzarias, $nome, $email, $cpf, $cep, $endereco, $numero, $complemento, $bairro, $cidade, $estado, $telefone_residencial, $telefone_recado, $celular, $id_nextel, $situacao, $data_nascimento, $sexo, $rg, $estado_civil, $tem_filhos, $escolaridade, $profissao, $fumante, $bebida_alcoolica, $animais_estimacao, $observacoes);
...
<table align="center" class="caixa" cellpadding="0" cellspacing="0">
    ...
    <tr>
	  ...
	  <tr>
          ...
          $SqlBuscaPizzarias = "SELECT * FROM ipi_pizzarias p WHERE p.situacao='ATIVO' ORDER BY nome";
    ...
    <tr><td class="tdbl tdbr"><input type="text" name="data_nascimento" id="data_nascimento" maxlength="14" size="9" value="<? echo bd2data($obj_editar->data_nascimento) ?>" onKeyPress="return MascaraData(this,event)"></td></tr>
    ...
    <tr>
        <td class="legenda tdbl tdbr">
            <label class="requerido" for="cpf">CPF</label>
        </td>
    </tr>
    <tr>
        <td class="tdbl tdbr">
            <input class="requerido" type="text" name="cpf" id="cpf" maxlength="14" size="20" onkeypress="return MascaraCPF(this, event);" value="<?echo bd2texto($obj_editar->cpf)?>">
        </td>
    </tr>
    ...
    <tr>
        <td class="tdbl tdbr">
            <input type="text" name="rg" id="rg" maxlength="25" size="20" value="<?echo bd2texto($obj_editar->rg)?>">
        </td>
    </tr>
    ...
    <tr>
        <td class="tdbl tdbr sep">
            <input type="text" name="profissao" id="profissao" maxlength="50" size="45" value="<?echo bd2texto($obj_editar->profissao)?>">
        </td>
    </tr>
    ...
    <tr>  
       <td class="legenda tdbl  tdbr">   
          <input type="text" name="numero" id="numero" maxlength="10" size="10" value="<? echo $obj_editar->numero ?>">
          &nbsp;&nbsp;
    ...
    <tr>
        <td class="tdbl tdbr">
            <input type="text" onkeypress="return MascaraTelefone(this, event);" name="telefone_residencial" id="telefone_residencial" maxlength="14" size="20"  value="<?echo bd2texto($obj_editar->telefone_residencial)?>">
        </td>
    </tr>
    ...
    <tr>
        <td class="tdbl tdbr">
            <input type="text" onkeypress="return MascaraTelefone(this, event);" name="telefone_recado" id="telefone_recado" maxlength="14" size="20"  value="<?echo bd2texto($obj_editar->telefone_recado)?>">
        </td>
    </tr>
    ...
    <tr>
        <td class="tdbl tdbr">
            <input onkeypress="return MascaraTelefone(this, event);" type="text" name="celular" id="celular" maxlength="45" size="20" value="<?echo bd2texto($obj_editar->celular)?>">
        </td>
    </tr>
    
    <tr>
        <td class="legenda tdbl tdbr">
            <label for="id_nextel">Id Nextel</label>
        </td>
    </tr>
    <tr>
        <td class="tdbl tdbr">
            <input type="text" name="id_nextel" id="id_nextel" maxlength="14" size="20" value="<? echo bd2texto($obj_editar->id_nextel); ?>">
       </td>
    </tr>
