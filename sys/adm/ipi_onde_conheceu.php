...
cabecalho('Cadastro de Onde Conheceu');

$acao = validaVarPost('acao');

$chave_primaria = 'cod_onde_conheceu';
$tabela = 'ipi_onde_conheceu';
$campo_ordenacao = 'onde_conheceu';
$campo_filtro_padrao = 'onde_conheceu';
$quant_pagina = 50;
...
switch ($acao)
{
    ...
    case 'editar':
        ...
        if ($codigo <= 0)
        {
            $sql_edicao = sprintf("INSERT INTO $tabela (onde_conheceu, situacao) VALUES 
                ('%s', '%s')",$onde_conheceu, $situacao);
           // echo $sql_edicao;
        ...
        else
        {
            ...
            $sql_edicao = sprintf("UPDATE $tabela SET onde_conheceu = '%s', situacao = '%s' WHERE $chave_primaria = $codigo", $onde_conheceu, $situacao);
...
<table>
    <tr>
        ...
        <table align="center" class="caixa" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td  align="right" class="tdbl tdbb tdbr"><select
                    name="opcoes">
        ...
        <table class="listaEdicao" cellpadding="0" cellspacing="0"
            ...
            <thead>
                <tr>
                    ...
                    <td align="center">Onde conheceu</td>
            ...
            while ($obj_buscar_registros = mysql_fetch_object($res_buscar_registros))
            {
                ...
                echo '<td align="center"><a href="#" onclick="editar(' . $obj_buscar_registros->$chave_primaria . ')">' . ($obj_buscar_registros->onde_conheceu) . '</a></td>';
...
<table align="center" class="caixa" cellpadding="0" cellspacing="0">
    <tr>
        <td class="legenda tdbl tdbt tdbr">
            <label for="onde_conheceu" class="requerido" >Onde conheceu</label>
        </td>
    </tr>
    <tr>
        <td class="tdbl tdbr sep">
            <input type="text"  name="onde_conheceu" class="requerido" id="onde_conheceu" maxlength="45" size="20" value="<?echo ($obj_editar->onde_conheceu)?>">
        </td>
    </tr>
