...
if ( ($objBuscaPedido->forma_pg=="VISANET")||($objBuscaPedido->forma_pg=="MASTERCARDNET") )
{
    ...
    function getURL($var_tid, $var_price, $var_free)
    {
    ...
    $XMLtransacao = GetURL($ret_tid, $ret_price, $ret_free);
    ...
    if ($Erro == '') 
    {
        ...
        $nodeCAP = $objDom->getElementsByTagName('CAP')->item(0);
        $RETcap = $nodeCAP->nodeValue;
        ...
        echo '<b>Código de captura (cap): </b>' . $RETcap . '<br>';
        ...
        */
        ...
        if ( ($RETlr==0) || ($RETlr==11) )
        {
            ...
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES ($objBuscaPedido->cod_pedidos,'cap_IdReqLocaWeb','".$IdReqLocaWeb."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES ($objBuscaPedido->cod_pedidos,'cap_Operacao','".$Operacao."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES ($objBuscaPedido->cod_pedidos,'cap_RETlr','".$RETlr."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES ($objBuscaPedido->cod_pedidos,'cap_RETars','".utf8_decode($RETars)."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES ($objBuscaPedido->cod_pedidos,'cap_RETtid','".$RETtid."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES ($objBuscaPedido->cod_pedidos,'cap_RETcap','".$RETcap."')";
            $resAux =  mysql_query($sqlAux);
            $sqlAux = "INSERT INTO ipi_pedidos_detalhes_pg (cod_pedidos, chave, conteudo) VALUES ($objBuscaPedido->cod_pedidos,'cap_RETfree','".utf8_decode($RETfree)."')";
            $resAux =  mysql_query($sqlAux);
