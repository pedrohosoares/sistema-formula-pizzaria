...
switch($acao) {
  ...
  case 'editar_pizzarias':
    ...
    if($resultado)
    {
      mensagemOk('Cupon alterado com êxito!');
    }
    else
    {
...
<div id="tabs">
  ...
  <div class="painelTab">
    ...
    <form name="frmFiltro" method="post">
      ...
      ?>
      <tr>
        <td class="legenda tdbl  sep" align="right"><label for="tipo_criacao">Modo Criação:</label></td>
        <td class="sep ">&nbsp;</td>
        <td class="tdbr sep ">
...
<tr><input type="hidden" name="acao" value="editar_pizzarias"><td align="center" class="tdbl tdbb tdbr"><input name="botao_submit" class="botao" type="submit" value="Cadastrar"></td></tr>
    ...
    <tr><td class="legenda tdbl tdbr"><label class="requerido" for="data_inicio">Data de Inicio da Utilização</label></td></tr>
    <tr><td class="tdbl tdbr sep">
