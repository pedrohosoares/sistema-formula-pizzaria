...
$chave_primaria = 'cod_setor';
$tabela = 'ipi_setores';
$campo_ordenacao = 'nome_setor';
$campo_filtro_padrao = 'nome_setor';
$quant_pagina = 50;
...
switch ($acao)
{
    ...
    case 'editar':
        ...
        $nome_setor = validaVarPost('nome_setor');

        $conexao = conectabd();
        
        if ($codigo <= 0)
        {
            $sql_edicao = sprintf("INSERT INTO $tabela (nome_setor) VALUES ('%s')", $nome_setor);
        ...
        {
            $sql_edicao = sprintf("UPDATE $tabela SET nome_setor = '%s' WHERE $chave_primaria = $codigo", $nome_setor);
    ...
    <tr>
        ...
        <table class="listaEdicao" cellpadding="0" cellspacing="0"
            ...
            while ($obj_buscar_registros = mysql_fetch_object($res_buscar_registros))
            {
                ...
                echo '<td align="center"><a href="#" onclick="editar(' . $obj_buscar_registros->$chave_primaria . ')">' . bd2texto($obj_buscar_registros->nome_setor) . '</a></td>';
  ...
  <table align="center" class="caixa" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td class="legenda tdbl tdbt tdbr">
            <label for="nome_setor" class="requerido">Setor</label>
        </td>
    </tr>
    <tr>
        <td class="tdbl tdbr sep">
            <input type="text"  name="nome_setor" class="requerido" id="nome_setor" maxlength="45" size="20" value="<? echo bd2texto($obj_editar->nome_setor); ?>">
        </td>
    </tr>
