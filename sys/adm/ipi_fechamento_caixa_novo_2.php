...
<script>
	function fechar_caixa()
	{
		...
		let total_pedidos_abertos = document.querySelector('td.total_pedidos_abertos');
		...
		if($cod_pizzarias > 0):
			...
			<tr>
				<td class="legenda tdbl tdbr">
					<label for="total_pedidos_abertos">Total pedidos ABERTOS: </label>
				</td>
			</tr>
			<tr>
				<td class='tdbl tdbr total_pedidos_abertos'>R$<?php echo $total; ?></td>
			</tr>
			<tr>
