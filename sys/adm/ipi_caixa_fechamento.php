...
*/
            ...
            if(true)
            {
                ...
                for ($a = 0; $a < $num_formas_pg; $a++)
                {
                    ...
                    $objBuscaPedidosSoma = executaBuscaSimples("SELECT SUM(valor_total) AS soma_mesa FROM ipi_pedidos p INNER JOIN ipi_pizzarias pi ON (p.cod_pizzarias = pi.cod_pizzarias) WHERE p.data_hora_pedido BETWEEN '$data_inicial 00:00:00' AND '$data_final 23:59:59' AND p.forma_pg = '".$obj_formas_pg->forma_pg."' AND p.origem_pedido = 'MESA' AND p.situacao NOT IN ('CANCELADO') AND p.cod_pizzarias = $cod_pizzarias", $conexao);
                    ...
                    $objBuscaPedidosSoma = executaBuscaSimples("SELECT SUM(valor_total) AS soma_tel FROM ipi_pedidos p INNER JOIN ipi_pizzarias pi ON (p.cod_pizzarias = pi.cod_pizzarias) WHERE p.data_hora_pedido BETWEEN '$data_inicial 00:00:00' AND '$data_final 23:59:59' AND p.forma_pg = '".$obj_formas_pg->forma_pg."' AND p.origem_pedido = 'TEL' AND p.situacao NOT IN ('CANCELADO') AND p.cod_pizzarias = $cod_pizzarias", $conexao);
                    ...
                    $objBuscaPedidosSoma = executaBuscaSimples("SELECT SUM(valor_total) AS soma_net FROM ipi_pedidos p INNER JOIN ipi_pizzarias pi ON (p.cod_pizzarias = pi.cod_pizzarias) WHERE p.data_hora_pedido BETWEEN '$data_inicial 00:00:00' AND '$data_final 23:59:59' AND p.forma_pg = '".$obj_formas_pg->forma_pg."' AND p.origem_pedido = 'NET' AND p.situacao NOT IN ('CANCELADO') AND p.cod_pizzarias = $cod_pizzarias", $conexao);
                ...
                $rel_fechamento .= '<tr>' . "\r\n";
                $rel_fechamento .= '<td style="background-color: #e5e5e5;" align="center"><b>Pizzas Salgadas</b></td>' . "\r\n";
                ...
                $rel_fechamento .= '<tr>' . "\r\n";
                $rel_fechamento .= '<td style="background-color: #e5e5e5;" align="center"><b>Pizzas Doces</b></td>' . "\r\n";
                ...
                $rel_fechamento .= '<tr>' . "\r\n";
                $rel_fechamento .= '<td style="background-color: #e5e5e5;" align="center"><b>Média de Pizzas Vendidas por Pedidos</b></td>' . "\r\n";
                ...
                $rel_fechamento .= '<tr>' . "\r\n";
                $rel_fechamento .= '<td align="center" style="background-color: #e5e5e5;"><b>Cupons de Pizza</b></td>' . "\r\n";
...
function fechar_caixa()
{
	...
	{
        if(document.frmIncluir.tempo_maximo.value>=50 && document.frmIncluir.motivo_gargalo.value=="")
        {
...
<tr>
	...
	for ($a = 0; $a < $num_formas_pg; $a++)
	{
		...
		$objBuscaPedidosSoma = executaBuscaSimples("SELECT SUM(valor_total) AS soma_tel FROM ipi_pedidos p INNER JOIN ipi_pizzarias pi ON (p.cod_pizzarias = pi.cod_pizzarias) WHERE p.data_hora_pedido BETWEEN '$data_inicial 00:00:00' AND '$data_final 23:59:59' AND p.forma_pg = '".$obj_formas_pg->forma_pg."' AND p.origem_pedido = 'TEL' AND p.situacao = 'BAIXADO' AND p.cod_pizzarias = $cod_pizzarias", $conexao);
		$soma_tel = $objBuscaPedidosSoma->soma_tel;
		$rel_fechamento .= '<td align="center">' . bd2moeda($soma_tel) . '</td>';
                
		$objBuscaPedidosSoma = executaBuscaSimples("SELECT SUM(valor_total) AS soma_net FROM ipi_pedidos p INNER JOIN ipi_pizzarias pi ON (p.cod_pizzarias = pi.cod_pizzarias) WHERE p.data_hora_pedido BETWEEN '$data_inicial 00:00:00' AND '$data_final 23:59:59' AND p.forma_pg = '".$obj_formas_pg->forma_pg."' AND p.origem_pedido = 'NET' AND p.situacao = 'BAIXADO' AND p.cod_pizzarias = $cod_pizzarias", $conexao);
		$soma_net = $objBuscaPedidosSoma->soma_net;
		$rel_fechamento .= '<td align="center">' . bd2moeda($soma_net) . '</td>';
    ...
    $rel_fechamento .= '<td align="center">' . bd2moeda($soma_mesa) . '</td>';
		...
		$objBuscaPedidosSoma = executaBuscaSimples("SELECT SUM(valor_total) AS soma_tel FROM ipi_pedidos p INNER JOIN ipi_pizzarias pi ON (p.cod_pizzarias = pi.cod_pizzarias) WHERE p.data_hora_pedido BETWEEN '$data_inicial 00:00:00' AND '$data_final 23:59:59' AND p.forma_pg = '".$obj_formas_pg->forma_pg."' AND p.origem_pedido = 'TEL' AND p.situacao NOT IN ('BAIXADO', 'CANCELADO') AND p.cod_pizzarias = $cod_pizzarias", $conexao);
		$soma_tel = $objBuscaPedidosSoma->soma_tel;
		$rel_fechamento .= '<td align="center">' . bd2moeda($soma_tel) . '</td>';
                
		$objBuscaPedidosSoma = executaBuscaSimples("SELECT SUM(valor_total) AS soma_net FROM ipi_pedidos p INNER JOIN ipi_pizzarias pi ON (p.cod_pizzarias = pi.cod_pizzarias) WHERE p.data_hora_pedido BETWEEN '$data_inicial 00:00:00' AND '$data_final 23:59:59' AND p.forma_pg = '".$obj_formas_pg->forma_pg."' AND p.origem_pedido = 'NET' AND p.situacao NOT IN ('BAIXADO', 'CANCELADO') AND p.cod_pizzarias = $cod_pizzarias", $conexao);
		$soma_net = $objBuscaPedidosSoma->soma_net;
		$rel_fechamento .= '<td align="center">' . bd2moeda($soma_net) . '</td>';
