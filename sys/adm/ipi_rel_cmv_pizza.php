<?php
  ...
  cabecalho('Relatório CMV por '.TIPO_PRODUTO);

  $acao = validaVarPost('acao');
  $cod_pizzarias = (validaVarPost('cod_pizzarias') ? validaVarPost('cod_pizzarias') : validaVarGet("cp"));
  $cod_pizzas = (validar_var_post("cod_pizzas") ? validar_var_post("cod_pizzas") : (validaVarGet("p") ? validaVarGet("p") : 0));
...
<div>
  ...
  <?
    if ( ($cod_pizzarias) || ($mes) )
    {
      ...
      echo 'Selecione a '.TIPO_EMPRESA.' e o '.TIPO_PRODUTO.'!';
  ?>
  </div>
</div>
