...
<tr>
  <td class="tdbl tdbr">
    <input type="text" name="dados_extra[ifood][merchant_id]" id="dados_extra[ifood][merchant_id]" value="<?php echo isset($dados_extra_busca['ifood']['merchant_id'])?$dados_extra_busca['ifood']['merchant_id']:''; ?>">
  </td>
</tr>
<?php } ?>
