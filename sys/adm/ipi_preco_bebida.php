      ...
      <form name="frmExcluir" method="post" onsubmit="return verificaCheckbox(this)">
        ...
        <table class="listaEdicao" cellpadding="0" cellspacing="0">
          ...
          while ($objBuscaRegistros = mysql_fetch_object($resBuscaRegistros)) {
            ...
            echo '<td align="center"><a href="javascript:;" onclick="editar('.$objBuscaRegistros->$chave_primaria.')">B-'.$objBuscaRegistros->cod_tipo_bebida.'-'.$objBuscaRegistros->cod_conteudos.'-'.$objBuscaRegistros->cod_bebidas.'-'.$objBuscaRegistros->cod_bebidas_ipi_conteudos.'</a></td>';
