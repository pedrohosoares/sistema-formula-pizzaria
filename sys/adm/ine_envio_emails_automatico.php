...
//$limite_envio = 15;
$limite_envio = 275; //TODO: NGINX ta dando timeout, rever esse numero Fazer a conta do limite atual dividido por 24h dividido por 6 (o disparo na dreamhost de 10 em 10 min, dá 6 por hora)
...
$mail->SmtpClose();
 ...
 desconectabd($con); // o script acima esta levando mais de 15min pra rodar, imaginamos que está dando timeout na conexao do mysql, pq as queries abaixo não rodavam, por isso reconectamos, contudo reconectar com a mesma variavel estava causando um erro estranho, por tanto tivemos q disconectar depois reconectar
 $con = conectabd(); 
/*
  echo "<br><br><br>Conexao: ".$con;
