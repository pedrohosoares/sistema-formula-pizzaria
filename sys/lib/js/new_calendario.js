...
this.vlaDatePicker = Picker.Date = new Class({
	...
	week: 'Wk'
		...
		if(options.openWith)
		{
			...
			this.options.toggle = options.openWith
			
			//this.attach(this.options.openWith);
		}
		
		this.parent(attachTo, options);
		//this.attachTo = document.getElementById(attachTo);
		...
		/*if(this.options.openWith)
		{
			//this.options.toggleElements = this.options.openWith
			this.attach(this.options.openWith);
		}*/
